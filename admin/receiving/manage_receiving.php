...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo !isset($id) ? "Nhận đơn hàng từ ".$po_code : 'Update Received Order' ?></h4>
    </div>
    <div class="card-body">
        <form action="" id="receive-form">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php else: ?>
                    <div class="col-md-6">
                        <label class="control-label text-info">Mã hàng dự trữ</label>
                        <input type="text" class="form-control form-control-sm rounded-0"
                            value="<?php echo isset($bo_code) ? $bo_code : '' ?>" readonly>
                    </div>
                    <?php endif; ?>
                    <div class="col-md-6">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-1 px-2 text-center qty">
                                <input type="number" name="qty[]" style="width:50px !important"
                                    value="<?php echo $row['qty']; ?>" max="<?php echo $row['quantity']; ?>" min="0">
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-primary" type="submit" form="receive-form">Lưu</button>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=purchase_order' ?>">Quay lại</a>
    </div>
</div>
<script>
$(function() {
            ...
            success: function(resp) {
                if (resp.status == 'success') {
                    location.replace(_base_url_ +
                        "admin/?page=receiving/view_receiving&id=" + resp.id);

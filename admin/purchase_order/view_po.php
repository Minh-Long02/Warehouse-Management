...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Chi tiết đơn đặt hàng - <?php echo $po_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <?php if($status > 0): ?>
                <div class="col-md-6">
                    <span class="text-info"><?php echo ($status == 2)? "ĐÃ NHẬN" : "ĐANG XỬ LÝ" ?></span>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary"
            href="<?php echo base_url.'/admin?page=purchase_order/manage_po&id='.(isset($id) ? $id : '') ?>">Sửa</a>

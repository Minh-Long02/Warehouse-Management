...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">
            <?php echo isset($id) ? "Chi tiết đơn đặt hàng - ".$po_code : 'Tạo mới đơn đặt hàng' ?></h4>
    </div>
    <div class="card-body">
        <form action="" id="po-form">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label text-info">Mã gửi hàng</label>
                ...
                <hr>
                <fieldset>
                    <legend class="text-info">Chi tiết Mặt hàng</legend>
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="item_id" class="control-label">Mặt hàng</label>
                ...
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <thead>
                        <tr class="text-light bg-navy">
                            ...
                            <th class="text-center py-1 px-2">Mặt hàng</th>
                    ...
                    <tfoot>
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">Tổng tiền</th>
                            <th class="text-right py-1 px-2 sub-total">0</th>
                        </tr>
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">Giảm giá <input style="width:40px !important"
                        ...
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">Thuế <input style="width:40px !important"
                        ...
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">Tổng cộng
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-primary" type="submit" form="po-form">Lưu</button>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=purchase_order' ?>">Huỷ bỏ</a>
    </div>
</div>
...
$(function() {
    ...
    $('#item_id').select2({
        placeholder: "Vui lòng chọn nhà cung cấp trước",
        width: 'resolve',
    })
    ...
    $('#supplier_id').change(function() {
        ...
        if (!!items[supplier_id]) {
            ...
            list_item.then(function() {
                $('#item_id').select2({
                    placeholder: "Vui lòng chọn mục tại đây",
                    width: 'resolve',
                })
            })
        } else {
            list_item.then(function() {
                $('#item_id').select2({
                    placeholder: "Không có mục nào trong danh sách",
                    width: 'resolve',
                })
            })
        }
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (resp.status == 'success') {
                    location.replace(_base_url_ + "admin/?page=purchase_order/view_po&id=" +
                        resp.id);

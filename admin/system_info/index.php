...
<div class="col-lg-12">
    <div class="card card-outline card-primary">
        <div class="card-header">
            <h5 class="card-title">Thông tin của hệ thống</h5>
        ...
        <div class="card-body">
            <form action="" id="system-frm">
                ...
                <div class="form-group">
                    <label for="short_name" class="control-label">Tên viết tắt của hệ thống</label>
                ...
                <div class="form-group">
                    <label for="" class="control-label">Log hệ thống</label>
                    <div class="custom-file">
                        <input type="file" class="custom-file-input rounded-circle" id="customFile" name="img"
                            onchange="displayImg(this,$(this))">
                        <label class="custom-file-label" for="customFile">Chọn thư mục</label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="" class="control-label">Trang chủ</label>
                    <div class="custom-file">

...
<div class="row">
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Đơn hàng đã nhận</span>
                <span class="info-box-number text-right">
                    <?php 
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Đơn hàng dự trữ</span>
                <span class="info-box-number text-right">
                    <?php 
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Đơn hàng đã trả</span>
                <span class="info-box-number text-right">
                    <?php 
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Danh mục hàng</span>
                <span class="info-box-number text-right">
                    <?php 

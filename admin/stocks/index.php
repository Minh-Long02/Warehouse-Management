<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title">Danh hàng tồn kho </h3>
...
$(document).ready(function() {
    $('.delete_data').click(function() {
        _conf("Bạn có chắc chắn xóa vĩnh viễn Đơn hàng đã nhận này không?", "delete_receiving", [$(this)
            .attr('data-id')
        ])
    })
    $('.view_details').click(function() {
        uni_modal("Nhận thông tin chi tiết", "receiving/view_receiving.php?id=" + $(this).attr(
                'data-id'),
            'mid-large')
    })

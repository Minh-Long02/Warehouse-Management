...
<!-- Navbar -->
<nav
    class="main-header navbar navbar-expand navbar-dark border border-light border-top-0  border-left-0 border-right-0 navbar-light text-sm bg-lightblue">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
        <li class="nav-item">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a class="title-header" href="<?php echo base_url ?>">
        ...
        <li class="nav-item">
            <div class="btn-group nav-link">
                ...
                <div class="dropdown-menu" role="menu">
                    <a class="dropdown-item" href="<?php echo base_url.'admin/?page=user' ?>"><span
                            class="fa fa-user"></span> Thông tin tài khoản</a>

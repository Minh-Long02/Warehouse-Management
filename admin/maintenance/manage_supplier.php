...
<div class="container-fluid">
    <form action="" id="supplier-form">
        ...
        <div class="form-group">
            ...
            <input name="name" id="name" class="form-control rounded-0"
        ...
        <div class="form-group">
            <label for="cperson" class="control-label">Người liên hệ</label>
            <input name="cperson" id="cperson" class="form-control rounded-0"
                value="<?php echo isset($cperson) ? $cperson : ''; ?>">
        </div>
        <div class="form-group">
            <label for="contact" class="control-label">Liên hệ khác</label>
            <input name="contact" id="contact" class="form-control rounded-0"
        ...
        <div class="form-group">
            ...
            <select name="status" id="status" class="custom-select selevt">
                ...
                <option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Không hoạt động
                </option>
            </select>
        </div>
    </form>

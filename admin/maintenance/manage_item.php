...
<div class="container-fluid">
    <form action="" id="item-form">
        ...
        <div class="form-group">
            <label for="cost" class="control-label">Chi phí</label>
            <input type="number" name="cost" id="cost" step="any" class="form-control rounded-0 text-end"
                value="<?php echo isset($cost) ? $cost : ''; ?>">
        </div>
        <div class="form-group">

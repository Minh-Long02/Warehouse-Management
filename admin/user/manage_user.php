        ...
        <div class="container-fluid">
            ...
            <form action="" id="manage-user">
                ...
                <div class="form-group col-6">
                    ...
                    <small class="text-info"><i>Để trống nếu bạn không muốn thay đổi mật khẩu.</i></small>
                    <?php endif; ?>
                </div>
                <div class="form-group col-6">
                    ...
                    <select name="type" id="type" class="custom-select"
                        ...
                        <option value="1" <?php echo isset($type) && $type == 1 ? 'selected': '' ?>>Quản lý</option>
    ...
    <div class="card-footer">
        <div class="col-md-12">
            <div class="row">
                ...
                <a class="btn btn-sm btn-secondary" href="./?page=user/list">Huỷ bỏ</a>
            </div>
        </div>
    </div>
</div>

...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Chi tiết hoàn trả - ".$return_code : 'Tạo phiếu hoàn trả mới' ?>
        </h4>
    </div>
    <div class="card-body">
        <form action="" id="return-form">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label text-info">Mã hoàn trả</label>
                ...
                <hr>
                <fieldset>
                    <legend class="text-info">Phiếu danh mục hàng</legend>
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="item_id" class="control-label">Danh mục</label>
                ...
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <thead>
                        <tr class="text-light bg-navy">
                            ...
                            <th class="text-center py-1 px-2">Danh mục</th>
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-primary" type="submit" form="return-form">Lưu</button>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=return' ?>">Huỷ bỏ</a>
    </div>
</div>
...
$(function() {
    ...
    $('#item_id').select2({
        placeholder: "Vui lòng chọn nhà cung cấp trước tiên ",
        width: 'resolve',
    })
    ...
    $('#supplier_id').change(function() {
        ...
        if (!!items[supplier_id]) {
            ...
            list_item.then(function() {
                $('#item_id').select2({
                    placeholder: "Vui lòng chọn danh mục ở đây",
                    width: 'resolve',
                })
            })
        } else {
            list_item.then(function() {
                $('#item_id').select2({
                    placeholder: "Chưa có danh mục nào được liệt kê",
                    width: 'resolve',
                })
            })
        }
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (resp.status == 'success') {
                    location.replace(_base_url_ + "admin/?page=return/view_return&id=" +
                        resp.id);

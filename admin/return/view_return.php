...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Danh sách hoàn trả - <?php echo $return_code ?></h4>
    </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary"
            href="<?php echo base_url.'/admin?page=return/manage_return&id='.(isset($id) ? $id : '') ?>">Sửa</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=return' ?>">Quay lại danh sách</a>
    </div>
</div>
...
$(function() {
    $('#print').click(function() {
        ...
        _head.find('title').text("Trả lại bản ghi- Xem bản in")
